...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    OLED_Init();
    OLED_Clear();
    OLED_ShowString(0,0,"FOC Driver V1.0",16);
    show_str(0,16,"矢量控制驱动器",16,1);
    show_str(0,32,"控制模式:速度环",16,1);
    show_str(0,48,"速度:1200",16,1);
    OLED_Refresh_Gram();
    HAL_Delay(3000);
    HAL_Delay(3000);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_D0_Pin|OLED_D1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : OLED_D0_Pin OLED_D1_Pin */
